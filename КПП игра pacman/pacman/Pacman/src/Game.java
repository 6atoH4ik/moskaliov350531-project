...
public class Game extends Canvas implements Runnable, KeyListener{
	...
	public static final int START = 0, GAME = 1, WIN = 2, LOSE = 3;
	...
	private void render(){
		...
		if(STATE == GAME){
			...
			g.drawString("score is: " +str, xx +30, yy+360);
			...
			g.setColor(Color.white);
			g.setFont(new Font(Font.DIALOG, Font.BOLD, 46));
			g.drawString("YOU LOSE", xx + 200, yy+270);
			g.drawString("score is: " +str, xx +200, yy+360);
		}
		g.dispose();
		bs.show();
	}
